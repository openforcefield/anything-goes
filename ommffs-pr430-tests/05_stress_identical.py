"""Stress test: 50 identical pentanes — tests template caching."""
import time, copy
...
g = SMIRNOFFTemplateGenerator(molecules=[mol], forcefield=FF)
f = ForceField()
...
print(
    f"TEST 1 (50x identical pentane): IC={t_ic:.1f}s OF={t_of:.1f}s "
